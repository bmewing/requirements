...
REQ_FILE_DUPLICATE_REQ = "Double requirement given: %s (from %s (line %d)) (already in %s (from %s (line %d)), name='%s')\n"

AUTO_GEN_COMMENTS = c(
  "# Generated by requirements::rip_freeze().  Modify as needed.",
  "# Install using requirements::rip_install().",
  ""
)
